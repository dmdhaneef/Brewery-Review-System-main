...
<section class="account-form">
   ...
   <form action="" method="post">
      ...
      <p class="placeholder">Brewery Name<span>*</span></p>
      <input type="text" name="title" required maxlength="50" placeholder="Enter Brewery Name" class="box">
      <p class="placeholder">Brewery Review Description</p>
      <textarea name="description" class="box" placeholder="Enter Brewery Review Description" maxlength="1000" cols="30" rows="10"></textarea>
      <p class="placeholder">Brewery Rating <span>*</span></p>
